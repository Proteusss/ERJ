...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_V_and_M = QtWidgets.QVBoxLayout()
...
#"")
        self.video4_PushButton.setText("选择视频")
        self.video4_PushButton.setObjectName("video4_PushButton")
        self.video4_PushButton.clicked.connect(MainWindow.video4processing)
       ...
       # self.video4_lineEdit.setGeometry(QtCore.QRect(110, 70, 41, 20))
        ...
        self.video4_lineEdit.setPlaceholderText("输入人数阈值...")
        self.video4_lineEdit.setValidator(self.intValidator)
        ...
        self.video4_SetButton.setText("设定阈值")
        self.video4_SetButton.setObjectName("video4_SetButton")
        self.video4_SetButton.clicked.connect(MainWindow.set_video4_limit)
        self.video4_lineEdit.returnPressed.connect(MainWindow.set_video4_limit)
       ...
       # self.video4_graphicsView.setGeometry(QtCore.QRect(0, 0, 201, 71))
        ...
        self.video4_numLabel = QtWidgets.QLabel(self.video4_graphicsView)
        self.video4_numLabel.setObjectName("video4_numlabel")
        ...
        self.gridLayout_video4.addWidget(self.video4_numLabel, 9, 10, 1, 2)
...
#"")
        self.video1_PushButton.setText("选择视频")
        self.video1_PushButton.setObjectName("video1_PushButton")
        self.video1_PushButton.clicked.connect(MainWindow.video1processing)
        ...
        self.video1_lineEdit.setPlaceholderText("输入人数阈值...")
        self.video1_lineEdit.setValidator(self.intValidator)
        self.video1_SetButton.setText("设定阈值")
        self.video1_SetButton.setObjectName("video1_SetButton")
        self.video1_SetButton.clicked.connect(MainWindow.set_video1_limit)
        self.video1_lineEdit.returnPressed.connect(MainWindow.set_video1_limit)
       ...
       # self.video1_graphicsView.setGeometry(QtCore.QRect(0, 0, 201, 71))
        ...
        self.video1_numLabel = QtWidgets.QLabel(self.video1_graphicsView)
        self.video1_numLabel.setObjectName("video1_numlabel")
        ...
        self.gridLayout_video1.addWidget(self.video1_numLabel,9,10,1,2)
...
#"")
        self.video2_PushButton.setText("选择视频")
        self.video2_PushButton.setObjectName("video2_PushButton")
        self.video2_PushButton.clicked.connect(MainWindow.video2processing)
        ...
        self.video2_lineEdit.setPlaceholderText("输入人数阈值...")
        self.video2_lineEdit.setValidator(self.intValidator)
        self.video2_SetButton.setText("设定阈值")
        self.video2_SetButton.setObjectName("video2_SetButton")
        self.video2_SetButton.clicked.connect(MainWindow.set_video2_limit)
        self.video2_lineEdit.returnPressed.connect(MainWindow.set_video2_limit)
       ...
       # self.video2_graphicsView.setGeometry(QtCore.QRect(0, 0, 201, 71))
        ...
        self.video2_numLabel = QtWidgets.QLabel(self.video2_graphicsView)
        self.video2_numLabel.setObjectName("video2_numlabel")
        ...
        self.gridLayout_video2.addWidget(self.video2_numLabel, 9, 10, 1, 2)
...
#"")
        self.video3_PushButton.setText("选择视频")
        self.video3_PushButton.setObjectName("video3_PushButton")
        self.video3_PushButton.clicked.connect(MainWindow.video3processing)
        ...
        self.video3_lineEdit.setPlaceholderText("输入人数阈值...")
        self.video3_lineEdit.setValidator(self.intValidator)
        self.video3_SetButton.setText("设定阈值")
        self.video3_SetButton.setObjectName("video3_SetButton")
        self.video3_SetButton.clicked.connect(MainWindow.set_video3_limit)
        self.video3_lineEdit.returnPressed.connect(MainWindow.set_video3_limit)
        ...
        self.video3_numLabel = QtWidgets.QLabel(self.video3_graphicsView)
        self.video3_numLabel.setObjectName("video3_numlabel")
        ...
        self.gridLayout_video3.addWidget(self.video3_numLabel, 9, 10, 1, 2)
        ...
        self.gridLayout_V_and_M.setStretchFactor(self.videoWidget,20)
        self.gridLayout_V_and_M.setStretchFactor(self.messageWidget,3)
    ...
    def retranslateUi(self, MainWindow):
        ...
        #self.video1_PushButton.setText(_translate("MainWindow", "选择视频"))
